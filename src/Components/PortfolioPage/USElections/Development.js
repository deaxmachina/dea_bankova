...
const Development = ({ children }) => {
    ...
    return (
        <div class='text-well'>
            ...
            {/* Custom layers */}
            <div><span className='listing highlight'>Custom layers</span> supporting various pattern fills, as well as circle layers.</div>
            
            {/* Custom interaction behaviours */}
            <div><span className='listing highlight'>Custom interaction behaviours</span> for an improved user experience, including: </div>
            <ul>
            ...
            {/* Legends */}
            <div className="text">
                <span className='listing highlight'>Separate legends for each map</span>
                , dynamically changing depending on whether the user has clicked on a state or is viewing 
                the map in its entirety. This ensures only the relevant legend is shown at each stage, avoiding clutter on the page.
            </div>

            {/* Tooltips */}
            <div className="text"><span className='listing highlight'>Custom tooltips</span> transforming into modals on mobile</div>
            <ul>
