  ...
  return (
    <div>
      ...
      <ul className="post__list-in-body">
        <li>
          <span className="post__highlighted-text">All of our graph code is now stored in a useEffect.</span>      
        ...
        <li>
          ...
          or <span className="post__emph-text">don't use <code className="code">append</code> but instead use <code className="code">selectAll-data-join</code></span>
